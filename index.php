...
// --------------------------------------------------------------------
    ...
    <body class="hold-transition login-page" style="background-color: #F3F3F3;">
        <div class="body_sub">
            <div class="login-box">
                <div class="logo-top text-center">
                    <br>
                    <h3 style="color: #7A54D8;">Client Manager & POS</h3>
                </div>
                <div class="">
                ...
                <div class="login-box-body">
                    ...
                    <form method="post" class="contact1-form">
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-xs-4">
                                <input type="button" value="Login" class="btn btn-primary btn-block btn-flat log_btn">
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
