...
class Mdl_Clients extends Response_Model
{
    ...
    public function validation_rules()
    {
        return array(
            ...
            'client_anniversary' => array(
                'field' => 'client_anniversary',
                'rules' => 'callback_convert_date'
            ),
            'client_gender' => array(
                'field' => 'client_gender'
    ...
    public function usual_services($id)
    {
	...
	public function search_birthdays($data=null)
	{
		if($data)
		{
	...
	public function search_anniversary($data=null)
	{
		if($data)
		{
    ...
    public function clients_count_by_date($start_date,$end_date)
    {
