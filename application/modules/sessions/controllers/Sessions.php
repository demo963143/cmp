...
class Sessions extends Base_Controller
{
    ...
    public function logout()
    {
		...
		$log_in_time=$this->session->userdata('log_in_time');
		$browser=$this->agent->browser();
		$version=$this->agent->version();
		$ip_address=$this->input->ip_address();
		$address="City ".$city.", region ".$region.", latitude ".$lat.", longitude ".$long;
		$browser_name=$browser." version ".$version;
		...
		//print_r($data);
		$this->db->insert('ip_login_logs',$data);
