                ...
                <td>
                    <div class="options btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a onclick='sendSms(<?php echo "\"$payment->client_name\",$payment->client_mobile,$payment->payment_amount,\"$payment->payment_method_name\"";?>)'>
...
function sendSms(name, phone, amount, method){
    jQuery.ajax({
        url: "<?php echo site_url('payments/sendpaymentSms') ?>",
        type: 'POST',
        "data": {'name':name,'phone': phone, 'amount':amount,'method':method},
       // dataType: 'json',
