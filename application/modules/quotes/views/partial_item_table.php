    ...
    <table id="item_table" class="items table table-condensed table-bordered no-margin">
        ...
        <tr>
            ...
            <td class="td-amount td-quantity">
                <div class="input-group">
                    ...
                    <input type="text" name="item_quantity" id="item_quantity" onblur="calculate()" onkeyup="calculate()" class="input-sm form-control amount" value="">
                </div>
            </td>
            <td class="td-amount">
                <div class="input-group">
                    <span class="input-group-addon"><?php _trans('price'); ?></span>
                    <input type="text" name="item_price" id="item_price" onblur="calculate()" onkeyup="calculate()" class="input-sm form-control amount" value="">
                </div>
            </td>
            <td class="td-amount ">
                <div class="input-group">
                    <span class="input-group-addon"><?php _trans('item_discount'); ?></span>
                    <input type="text" name="item_discount_amount" id="item_discount_amount" class="input-sm form-control amount"
        ...
        <tr>
            ...
            <td class="td-amount td-vert-middle">
                ...
                <span name="subtotal" id="subtotal" class="amount"></span>
            </td>
            <td class="td-amount td-vert-middle">
...
<div class="row">
    <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4 mrgn-bottom">
        <div class="btn-group">
...
function calculate(){
	...
	$('#item_discount_amount').val(subtotal);
}
</script>
