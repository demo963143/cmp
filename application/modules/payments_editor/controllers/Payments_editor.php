 ...
 * Class Payments
 */
class Payments_editor extends Editor_Controller
{
    /**
    ...
    {
        $this->mdl_payments->paginate(site_url('payments_editor/index'), $page);
        ...
        $this->layout->buffer('content', 'payments_editor/index');
    ...
    public function form($id = null)
    {
        ...
        if ($this->mdl_payments->run_validation()) {
            ...
            $this->load->model('clienteditor/mdl_payment_custom');

            $this->mdl_payment_custom->save_custom($id, $this->input->post('custom'));

            redirect('payments_editor');
        }
        ...
        $this->layout->buffer('content', 'payments_editor/form');
       $this->layout->render('layout_editor');
    }
