    ...
    <table class="table table-striped">
        ...
        <?php foreach ($payments as $payment) { ?>
            <tr>
                ...
                <td><?php echo anchor('invoices_editor/view/' . $payment->invoice_id, $payment->invoice_number); ?></td>
                <td>
                    <a href="<?php echo site_url('clienteditor/view/' . $payment->client_id); ?>"
                ...
                <td>
                    <div class="options btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('payments_editor/form/' . $payment->payment_id); ?>">
                                    <i class="fa fa-edit fa-margin"></i>
                                    <?php _trans('edit'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('payments_editor/delete/' . $payment->payment_id); ?>"
