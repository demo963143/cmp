    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="ip-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li class=""><?php echo anchor('dashboard', trans('dashboard'), 'class="hidden-md"') ?>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-md">Tenant</span>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo anchor('invoices/recurring/invoicesheet', trans('Invoice sheet')); ?></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo anchor('reports/activities', trans('activity')); ?></li>
                        <li><?php echo anchor('reports/login_logs', trans('login_logs')); ?></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
...
-->
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a 
                       class="tip icon logout" data-placement="bottom" onclick="delete_cookie();"
...
{
	$.ajax({
							url:'<?php echo site_url('sessions/logout'); ?>',
							type: 'GET', 
							success: function(data)
						{
							$.ajax({
							url:'https://<?php echo $_SERVER['SERVER_NAME']?>/login/ajax_call_out.php',
							type: 'POST', 
							success: function(data)
						{
