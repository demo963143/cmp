...
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/core/img/logo.png">
...
<script>
    ...
    $(function () {
        ...
        $(document).on('click', '.create-invoice', function () {
            $('#modal-placeholder').load("<?php echo site_url('clienteditor/ajax/modal_create_invoice'); ?>");
        });
        ...
        $(document).on('click', '.client-create-invoice', function () {
            var client_id = $(this).data('client-id');
            $('#modal-placeholder').load("<?php echo site_url('clienteditor/ajax/modal_create_invoice'); ?>", {client_id: client_id});
        });

        $(document).on('click', '.client-create-quote', function () {
            var client_id = $(this).data('client-id');
			
            $('#modal-placeholder').load("<?php echo site_url('clienteditor/ajax/modal_create_quote'); ?>", {client_id: client_id});
        });
        ...
        $(document).on('click', '.invoice-add-payment', function () {
            ...
            $('#modal-placeholder').load("<?php echo site_url('payments_editor/ajax/modal_add_payment'); ?>", {
