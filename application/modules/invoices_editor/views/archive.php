<div id="headerbar">
    ...
    <div class="headerbar-item pull-right">
        <form action="<?php echo site_url('invoices_editor/archive/'); ?>" method="post">
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('invoices_editor/partial_invoice_archive', array('invoices_archive' => $invoices_archive)); ?>
    </div>
