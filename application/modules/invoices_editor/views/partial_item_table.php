        ...
        <?php foreach ($items as $item) { ?>
            ...
            <tr>
                ...
                <td class="td-icon text-right td-vert-middle">
                    <?php if ($invoice->is_read_only != 1): ?>
                        <a href="<?php echo site_url('invoices_editor/delete_item/' . $invoice->invoice_id . '/' . $item->item_id); ?>"
                ...
                <td>
                    <?php if ($invoice_tax_rates) {
                        foreach ($invoice_tax_rates as $invoice_tax_rate) { ?>
                            ...
                            <?php echo anchor('invoices_editor/delete_invoice_tax/' . $invoice->invoice_id . '/' . $invoice_tax_rate->invoice_tax_rate_id, '<i class="fa fa-trash-o"></i>');
