...
<script>
    ...
    $(function () {
        ...
        $('#btn_create_recurring').click(function () {
            $('#modal-placeholder').load(
                "<?php echo site_url('invoices_editor/ajax/modal_create_recurring'); ?>",
                {
        ...
        $('#invoice_change_client').click(function () {
            $('#modal-placeholder').load("<?php echo site_url('invoices_editor/ajax/modal_change_client'); ?>", {
                invoice_id: <?php echo $invoice_id; ?>,
        ...
        $('#btn_save_invoice').click(function () {
            ...
            $.post("<?php echo site_url('invoices_editor/ajax/save'); ?>", {
                    invoice_id: <?php echo $invoice_id; ?>,
        ...
        $('#btn_generate_pdf').click(function () {
            window.open('<?php echo site_url('invoices_editor/generate_sumex_copy/' . $invoice_id); ?>', '_blank');
        });

        $('#btn_sumex').click(function () {
            window.open('<?php echo site_url('invoices_editor/generate_sumex_pdf/' . $invoice_id); ?>', '_blank');
        });
                        ...
                        <div class=" row">
                            ...
                            <?php if ($invoice->invoice_sign == -1) { ?>
                                ...
                                <span class="label label-warning">
                                    ...
                                    echo anchor('/invoices_editor/view/' . $invoice->creditinvoice_parent_id,
