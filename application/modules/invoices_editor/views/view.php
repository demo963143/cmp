    ...
    $(function () {
        ...
        $('.btn_add_product').click(function () {
            $('#modal-placeholder').load(
                "<?php echo site_url('products/ajax_editor/modal_product_lookups'); ?>/" + Math.floor(Math.random() * 1000)
            );
        });

        $('.btn_add_task').click(function () {
            $('#modal-placeholder').load("<?php echo site_url('tasks/ajax_editor/modal_task_lookups/' . $invoice_id); ?>/" + Math.floor(Math.random() * 1000));
        });
        ...
        $('#btn_create_recurring').click(function () {
            $('#modal-placeholder').load(
                "<?php echo site_url('invoices_editor/ajax_editor/modal_create_recurring'); ?>",
                {
        ...
        $('#invoice_change_client').click(function () {
            $('#modal-placeholder').load("<?php echo site_url('invoices_editor/ajax_editor/modal_change_client'); ?>", {
                invoice_id: <?php echo $invoice_id; ?>,
        ...
        $('#btn_save_invoice').click(function () {
            ...
            $.post("<?php echo site_url('invoices_editor/ajax_editor/save'); ?>", {
                    invoice_id: <?php echo $invoice_id; ?>,
                ...
                function (data) {
                    ...
                    if (response.success === 1) {
                        window.location = "<?php echo site_url('invoices_editor/view'); ?>/" + <?php echo $invoice_id; ?>;
                    } else {
        ...
        $('#btn_generate_pdf').click(function () {
            window.open('<?php echo site_url('invoices_editor/generate_pdf/' . $invoice_id); ?>', '_blank');
        });
...
<div id="content">
        ...
        <div class="invoice">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-5">
                    ...
                    <h3>
                        <a href="<?php echo site_url('clienteditor/view/' . $invoice->client_id); ?>">
                    ...
                    <div class="client-address">
                        <?php $this->layout->load_view('clienteditor/partial_client_address', array('client' => $invoice)); ?>
                    </div>
 ...
 <hr>
                ...
                <div class="col-xs-12 col-sm-5 col-md-7 lft">
                            ...
                            <?php if ($invoice->invoice_sign == -1) { ?>
                                <div class="col-xs-12">
                                    <div class="alert alert-warning small">
                                        ...
                                        echo anchor('/invoices_editor/view/' . $invoice->creditinvoice_parent_id, $parent_invoice_number);
                                        ?>
                                    </div>
                                </div>
                            <?php } ?>
            ...
            <?php $this->layout->load_view('invoices_editor/partial_item_table'); ?>
