<script>
    $(function () {
        ...
        <?php $this->layout->load_view('clienteditor/script_select2_client_id.js'); ?>

        // Creates the invoice
        $('#client_change_confirm').click(function () {
            // Posts the data to validate and create the invoice;
            // will create the new client if necessary
            $.post("<?php echo site_url('invoices_editor/ajax_editor/change_client'); ?>", {
                ...
                function (data) {
                    ...
                    if (response.success === 1) {
                        ...
                        window.location = "<?php echo site_url('invoices_editor/view'); ?>/" + response.invoice_id;
                    }
                    else {
