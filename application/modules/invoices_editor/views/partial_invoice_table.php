    ...
    <table class="table table-striped">
        ...
        foreach ($invoices as $invoice) {
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('invoices_editor/view/' . $invoice->invoice_id); ?>"
                ...
                <td>
                    <div class="options btn-group<?php echo $dropup ? ' dropup' : ''; ?>">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php } ?>
                            <li>
                                <a href="<?php echo site_url('invoices_editor/generate_pdf/' . $invoice->invoice_id); ?>"
                                   target="_blank">
                            ...
                            <?php if ($invoice->invoice_status_id == 1 || ($this->config->item('enable_invoice_deletion') === true && $invoice->is_read_only != 1)) { ?>
                                <li>
                                    <a href="<?php echo site_url('invoices_editor/delete/' . $invoice->invoice_id); ?>"
