 ...
 * Class Ajax
 */
class Ajax_editor extends Editor_Controller
{
    public $ajax_controller = true;

    public function save()
    {
        $this->load->model('invoices_editor/mdl_items');
        $this->load->model('invoices_editor/mdl_invoices');
        $this->load->model('clienteditor/mdl_units');
        $this->load->model('invoices_editor/mdl_invoice_sumex');
        ...
        if ($this->mdl_invoices->run_validation('validation_rules_save_invoice')) {
            ...
            $this->load->model('invoices_editor/mdl_invoice_amounts');
    ...
    {
        $this->load->model('invoices_editor/mdl_invoice_tax_rates');
    ...
    {
        $this->load->model('invoices_editor/mdl_invoices_recurring');
    ...
    public function modal_create_invoice()
    {
        ...
        $this->layout->load_view('invoices_editor/modal_create_invoice', $data);
    }
    ...
    public function modal_change_client()
    {
        ...
        $this->layout->load_view('invoices_editor/modal_change_client', $data);
    }
    ...
    public function modal_copy_invoice()
    {
        ...
        $this->layout->load_view('invoices_editor/modal_copy_invoice', $data);
    }
    ...
    public function modal_create_credit()
    {
        ...
        $this->layout->load_view('invoices_editor/modal_create_credit', $data);
    }
