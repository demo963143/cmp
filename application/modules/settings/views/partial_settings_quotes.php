        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="form-group">
                        <label>
                            <?php _trans('quote_logo'); ?>
                        </label>
                        <?php if (get_setting('quote_logo')) { ?>
                            <img class="personal_logo"
                                 src="<?php echo base_url(); ?>uploads/<?php echo get_setting('quote_logo'); ?>">
                            <br>
                            <?php echo anchor('settings/remove_logo/quote', 'Remove Logo'); ?><br>
                        <?php } ?>
                        <input type="file" name="quote_logo" size="40" class="form-control"/>
                    </div>
