...
<script>
    $(function () {
        ...
        /*$('#btn_generate_pdf').click(function () {
            window.open('<?php echo site_url('invoices/generate_pdf_test/' . $invoice_id); ?>', '_blank');
        });*/
             ...
             <?php
                   ...
                   foreach($resultval as $value){  
                       ...
                       $discountamount += $amountsinglediscount;
                        $val .= ' '.$i.': '.$value['item_name'].'= '.$value['item_quantity'].'X'.$value['item_price'].'='.$amountsingle ."%0A%0A";
                   }
