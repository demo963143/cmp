<script>
    $(function () {
        $('#save_client_note').click(function () {
            $.post('<?php echo site_url('clienteditor/ajax/save_client_note'); ?>',
                {
                    ...
                    if (response.success === 1) {
                        ...
                        // Reload all notes
                        $('#notes_list').load("<?php echo site_url('clienteditor/ajax/load_client_notes'); ?>",
                            {
...
<div id="headerbar">
    ...
    <div class="headerbar-item pull-right">
        <div class="btn-group btn-group-sm">
            ...
            <a href="<?php echo site_url('clienteditor/form/' . $client->client_id); ?>"
               class="btn btn-default">
                <i class="fa fa-edit"></i> <?php _trans('edit'); ?>
            </a>
            <a class="btn btn-danger"
               href="<?php echo site_url('clienteditor/delete/' . $client->client_id); ?>"
        ...
        <div id="clientDetails" class="tab-pane tab-rich-content active">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <p class="bold">
                        <?php $this->layout->load_view('clienteditor/partial_client_address'); ?>
                    </p>
                            ...
                            <div class="panel-body table-content">
                                <table class="table">
                                    <tr>
										...
										<?php 
										if(!isset($client->client_birthdate)){
											?>
