    ...
    <table class="table table-striped">
        ...
        <?php foreach ($records as $client) : ?>
            <tr>
                ...
                <td><?php echo anchor('clienteditor/view/' . $client->client_id, htmlsc(format_client($client))); ?></td>
                ...
                <td>
                    <div class="options btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('clienteditor/view/' . $client->client_id); ?>">
                          ...
                          <!--  <li>
                            ...
                            <li>
                                <a href="<?php echo site_url('clienteditor/delete/' . $client->client_id); ?>"
