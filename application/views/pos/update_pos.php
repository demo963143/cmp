        ...
        <div class="card">
            <div class="card-body p-2">
                ...
                <div class="scroll dashboard-list-with-thumbs ps ps--active-y" id="productList" style="display:block;height:500px">
                    ...
                    ?>
                            <a href="javascript:void(0)" class="btn btn-light default mb-1 mr-1 addPct" style="width: 21%!important; border-top:4px solid #138496; height:100px" id="<?= $product->num; ?>" onclick="add_prodpos('<?= $product->id; ?>')">
    ...
    <div class="col-xl-4 col-lg-12 mb-0">
        ...
        <div class="card">
            <div class="row px-4 py-1">
                <input type="text" id="salesearch" class="form-control col-8 mr-2 mb-1" placeholder=" <?= display('find_an_invoice') ?> " style="font-size: 15px;">
                <button type="button" class="btn btn-primary  text-center default mr-2 mb-1" onclick="SaleSearch()">
                 <i class="simple-icon-magnifier"></i>
                </button>
                ...
                <div class="row p-3">
                    ...
                    <select id="customerSelect" name="" class="form-control select2-single" data-width="50%" data-height="20%">
                        ...
                        foreach ($clients as $client) {
                            $selected = ($client->id == $sale_id[0]->client_id) ? 'selected' : ''; // Check if client_id matches
                        ?>
                            <option value="<?= $client->id; ?>" <?= $selected; ?>><?= $client->lastname . ' ' . $client->firstname . ' ' . $client->phone; ?></option>
                        <?php
                        }
                        ?>
                    </select>
                    ...
                    <button type="button" class="btn btn-primary  text-center default mr-2 mb-1" data-toggle="modal" data-target="#clientModal">
                    ...
                    <div class="input-group col-lg-8 mt-1 pl-0">
                             ...
                             <input type="text" class="form-control" id="phoneClient" placeholder="<?= display('phone') ?>" value="<?= isset($sale_id[0]->phoneclient) ? $sale_id[0]->phoneclient : ''; ?>">
                             
                          <input type="text" class="form-control" id="saledata_id" value="<?= isset($sale_id[0]->id) ? $sale_id[0]->id : ''; ?>" hidden>
                        ...
                        <div class="input-group col-lg-12 mt-1 pl-0">
                             ...
                             <input type="date" class="form-control" id="pickup_date" name="pickup_date" placeholder="Pickup Date" value="<?=date('Y-m-d');?>" value="<?= isset($sale_id[0]->pickup_date) ? $sale_id[0]->pickup_date : ''; ?>">
                        </div>
                        <div class="input-group col-lg-12 mt-1 pl-0">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Delivery Date</div>
                                    </div>
                             <input type="date" class="form-control" id="delivery_date" name="delivery_date" placeholder="Delivery Date" value="<?= isset($sale_id[0]->delivery_date) ? $sale_id[0]->delivery_date : ''; ?>">
                        </div>
                        </div>
                        ...
                        <div class="" style="width:100%; border:1px solid #d7d7d7; padding:8px;">
                            <div class="" style="width:100%;">
                                <p style="margin-bottom:0px">Store</p>
                        
                                <div class="d-flex">
                                    <p style="margin-bottom:0px">Pickup</p>
                                    <input class="form-check-input input_box" type="radio" name="store_delivery" value="pickup" 
                                        <?= (isset($sale_id[0]->store_pickup_delivery) && $sale_id[0]->store_pickup_delivery == 'pickup') ? 'checked' : ''; ?>>
                                </div>
                        
                                <div class="d-flex">
                                    <p style="margin-bottom:0px">Delivery</p>
                                    <input class="form-check-input input_box" type="radio" name="store_delivery" value="delivery" 
                                        <?= (isset($sale_id[0]->store_pickup_delivery) && $sale_id[0]->store_pickup_delivery == 'delivery') ? 'checked' : ''; ?>>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-13">
                        <div class="info mt-4">
                            ...
                            <div class="scrollbar" id="style-1">
                                ...
                                //              <a href="#servicemodal" class="green" id="custId" data-toggle="modal" data-id="' . $posale->id . '"><span class="btn btn-success default">Add services</span></a>
                                ...
                                //              </div>
                            			 ...
                            			 $row .= '</div><div class="col-md-12">
                                                    <a href="javascript:void(0)" style="margin-bottom:5px;" onclick="edit_posale(' . "'" . $posale->id . "','increment'" . ')">
                                                        <span class="btn btn-outline-success btn-xs default mr-1"><i class="fa fa-plus"></i></span>
                                                    </a>
                                                    <a href="javascript:void(0)" onclick="edit_posale(' . "'" . $posale->id . "','decrement'" . ')">
                                                        <span class="btn btn-outline-danger btn-xs  default"><i class="fa fa-minus"></i></span>
                                                    </a>
                                                    <a href="#servicemodal" class="green" id="custId" data-toggle="modal" data-id="' . $posale->id . '">
                                                        <span class="btn btn-success btn-xs default"><i class="fa fa-plus"></i> Services</span>
                                                    </a>';
                                        
                                        if ($product->name == 'Laundry By Kilo') {
                                            $row .= '<a class="ml-2" href="#laundrybykilomodal" class="green" id="custId" data-toggle="modal" data-id="' . $posale->id . '">
                                                        <span class="btn btn-success btn-xs default"><i class="fa fa-plus"></i> Product</span>
                                                    </a>';
                                        }
                                        
                                        $row .= '<a class="ml-2 product_notesdata green" href="#noteslomodal" id="custId" data-toggle="modal" data-id="' . $posale->id . '">
                                                    <span class="btn btn-success btn-xs default"><i class="fa fa-plus"></i> Notes</span>
                                                </a>
                                               ';
                                            
                                            
                                        $row .= '<a class="ml-2 product_imagesdata green" href="#imagesmodel" id="custId" data-toggle="modal" data-id="' . $posale->id . '">
                                                    <span class="btn btn-success btn-xs default"><i class="fa fa-plus"></i> Image</span>
                                                </a>
                                                </div>
                                            </div>';
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="whiteBg" style="padding:3px"><input type="text" value="<?= isset($sale_id[0]->tax) ? $sale_id[0]->tax : ''; ?>" onchange="total_change()" id="taxValue" class="total-input TAX form-control" placeholder="" maxlength="5">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="active" style="padding:3px"><?= display('discounts'); ?></td>
                                            <td class="whiteBg" style="padding:3px"><input type="text" value="<?= isset($sale_id[0]->discount) ? $sale_id[0]->discount : ''; ?>" onchange="total_change()" id="RemiseValue" class="total-input Remise form-control" placeholder="" maxlength="5">
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <div class="card">
            <div class="card-body p-2">
                <div class="d-flex" style="justify-content: space-between;">
                    ...
                    <button style="width:32%;" type="button" class="btn btn-success btn-lg default float-left text-center" id="paid-btn" data-toggle="modal" data-target="#AddSale" disabled>
...
$(document).on('click', '.addinal-product-add', function (e) {
    ...
    */
    ...
    function saleBtn(type, printcheck=null) {
        ...
        var saledata_id = $('#saledata_id').val();
            ...
            <form>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <h2 id="customerName"><?= display('client') ?> <span> <?= isset($sale_id[0]->clientname) ? $sale_id[0]->clientname : ''; ?></span></h2>
    ...
    <div class="modal-dialog" role="document" id="ticketModal">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body" style="margin-top: 0px;padding: 5px; padding-bottom: 0px">
                <div id="printSection" class="printSection" style="padding-bottom:0px; padding-top: 0px; margin-top: 0px; margin-bottom: 0px;padding:15px;">
                    <!-- Ticket goes here -->
                    <center>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-danger pagereload hiddenpr" data-dismiss="modal"><?= display('close') ?></button>
                ...
                <a href="" class="btn btn-warning print_all_barcodes" target="_blank">Print Tag</a>
                
                <input class="saleid_data" value="" hidden>
                
                <button type="button" onclick="sendnotification()" class="btn btn-warning">Send Notification</button>
            </div>
        </div>
    </div>
</div>
                    ...
                    if (response.status && response.products.length > 0) {
                        ...
                        $.each(response.products, function (index, product) {
                            productHTML += `
                                <tr>
                                    <td>${index + 1}</td>
                                    <td class="product_name_model">${product.name}</td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary decrement" data-id="${product.id}">-</button>
                                        <input type="number" id="product_quantity_${product.id}" class="form-control product_quantity_model" min="0" value="0" style="width: 50px; display: inline-block; text-align: center;">
                                        <button type="button" class="btn btn-sm btn-primary increment" data-id="${product.id}">+</button>
                                     ...
                                     <td><button type="button" class="btn btn-sm btn-primary addinal-product-add" data-id="${product.id}">Add</button></td>
                                </tr>`;
                        });
        ...
        success: function(data) {
            try {
                ...
                if (result.status == 1) {
                    ...
                    Your Order ID: ${result.sales_id} is ready with amount of ${result.total_amount}.
