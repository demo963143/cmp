					...
					<div class="content_area ticket" style="border: 1px solid;padding:1px; width:250px;  text-align:center; margin:0 auto;">
						...
						<div class="text_area">
							<div class="row">
								<div class="col-sm-8">
									<div class="txt">
									    	<!--<p style="margin-bottom:0px; font-size:16px; font-weight:600;">Order ID.<?=$item->sale_id?></p>-->
									    <p style="margin-bottom:0px; font-size:16px; font-weight:600;">Order ID.<?=$sale->invoice_id?></p>
										    <p style="margin-bottom:1px; font-size:16px; font-weight:600;">Customer ID. ( CL<?=$customer->id?> )</p>
							...
							<div class="barcode_img">
								<img style="height:70px;" src="<?=base_url() . 'assets/images/barcode/' . $item->barcode.'.png'?>" alt="..." />
							</div>

							<div class="footer">
								<div class="footer_title">
										<!--<p style="margin-bottom:5px; font-size:24px; font-weight:600;"><?=$this->session->userdata('store_code')?><?=$i?>/<?=$items?></p>-->
								<p style="margin-bottom:1px; font-size:20px;"><?=$i?>/<?=$items?></p>
