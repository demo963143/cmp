                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$orderplaced->order_no ?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Picked_up_by_delivery_vandata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$delivered_at_plantdata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet header" style="border:1px solid #0089ff;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$recieved_at_plantdata->order_no ?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Sorting_and_processing_throughdata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Packing_and_sticker_printdata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="font-size:13px; float: right;">Ord No. <?=$ready_to_dispatchdata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Pick_up_by_delivery_vandata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Delivered_at_franchisedata->order_no?></h6>
                        </div>
                    </div>
        ...
        <div class="col-sm-12 mb-3 portlet">
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        <div class="col" style="padding-right:3px;">
                            <h6 onclick="showTicket1('<?=$Franchise_received_through_stickerdata->order_no?>')" style="font-size:13px;text-align:left; float: left;">
                                <?=$Franchise_received_through_stickerdata->clientname?></h6>
                        </div>
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size:13px;">Ord No. <?=$Franchise_received_through_stickerdata->order_no?></h6>
                        </div>
                    </div>
            ...
            <div class="card portlet-header" style="border:1px solid #13b313; cursor: pointer;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="padding-left:3px;">
                            <h6 style="float: right; font-size: 13px;">Ord No. <?=$delivered_to_customerdata->order_no?></h6>
                        </div>
                    </div>
