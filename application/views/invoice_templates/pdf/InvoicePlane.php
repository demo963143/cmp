...
<hr>
<h2 class="invoice-title" align="center" style="margin:0; padding:0"><?php _htmlsc($invoice->user_name); ?></h2>
...
<div id="client">
        ...
        if ($invoice->client_mobile) {
            echo '<div><b>' . htmlsc($invoice->client_mobile) . '</b></div>';
        }
        if ($invoice->client_email) {
            echo '<div>' . $invoice->client_email . '</div>';
        } ?>
        <?php echo trans('receipt_no') . ' ' . $invoice->invoice_number; ?>
