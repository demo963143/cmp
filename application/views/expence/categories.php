...
<div class="modal fade modal-right" id="exampleModalRight" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>  <?=display('category_name')?>  <span class="text-danger error_lastname">*</span></label>
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-lg-inline-block mb-sm-0 mb-2" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-backdrop="static" data-target="#exampleModalRight"><i class="fa fa-plus"></i> <?=display('add_new')?> </button>
                            </li>
                            <li class="breadcrumb-item">
                            <a href="<?=base_url('expences')?>"><button type="button" class="btn btn-primary" ><i class="glyph-icon simple-icon-list"></i> <?=display('list_of_expenses')?> </button></a>
                        </li>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('categorie_expences/ajax_categories/')?>",
            "type": "POST",
            "data":function(data) {
            },
        },
      ...
      $('#confirm-delete').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'POST',
            url : '<?php echo site_url();?>/categorie_expences/delete/', 
     ...
     $('#updateclt').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'POST',
            url : '<?php echo site_url();?>/categorie_expences/update/',
            data :  'category_id='+ expence_id,
            success : function(data){
   ...
   function deletebtm(idClt){
    $.ajax({
            url : "<?php echo base_url('categorie_expences/delete/')?>"+idClt,
            type: "POST",
            dataType : "JSON",
            data: {},
            success: function(data)
  ...
  function savebtm() {
   var name = $('#name').val();
     ...
     {
        $.ajax({
            url : "<?php echo base_url('categorie_expences/add')?>",
            type: "POST",
            dataType : "JSON",
            data: {name: name},
            success: function(data)
 ...
 function updatebtm() {
   ...
   var name = $('#nameup').val();
     ...
     {
        $.ajax({
            url : "<?php echo base_url('categorie_expences/update_ajax')?>",
            type: "POST",
            dataType : "JSON",
